...
3. **Critical-path flow diagrams** — graph build, schema level, MATLAB run DONE 2026-09-23; Python for_each + plot load need a measured run. — save, load/load_all, for_each (Py + MATLAB),
...
4. **Re-check 2026-09-20 review** — DONE 2026-09-23 (§4½). — mark closed/open items.
5. **Rank findings** — DONE 2026-09-23 (cleanup-audit §5 "Ranked next actions"). — severity × blast radius; each with suggested fix,
