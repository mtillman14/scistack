...
const styles: Record<string, React.CSSProperties> = {
  ...
  collapsed: {
    ...
    gap: 8, padding: '8px 4px', borderLeft: '1px solid var(--ps-border)', background: 'var(--ps-surface)',
  },
  verticalLabel: {
    writingMode: 'vertical-rl', color: 'var(--ps-text-muted)', fontSize: 11, cursor: 'pointer',
    letterSpacing: 0.6,
  },
  header: {
  ...
  title: { color: 'var(--ps-text)', fontSize: 13, fontWeight: 600 },
  body: { padding: 12, flex: 1, minHeight: 0, overflowY: 'auto', overflowX: 'hidden' },
  current: { marginBottom: 12 },
  currentName: {
    color: 'var(--ps-text)', fontSize: 12, fontWeight: 600, marginBottom: 2,
    whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
  },
  unsaved: { color: 'var(--ps-text-muted-neutral)', fontStyle: 'italic', fontWeight: 400 },
  meta: { fontSize: 10, color: 'var(--ps-text-muted-neutral)' },
  modifiedDot: { color: 'var(--ps-caution)' },
  headerButton: {
  ...
  primaryButton: {
    background: 'var(--ps-accent-bg-strong)', color: 'var(--ps-text)', border: '1px solid var(--ps-accent)',
    borderRadius: 4, cursor: 'pointer', fontSize: 11, padding: '3px 10px', marginTop: 6,
  },
  linkButton: {
    background: 'none', border: 'none', color: 'var(--ps-accent-text-alt)', cursor: 'pointer',
    fontSize: 10, padding: 0, textDecoration: 'underline',
  },
  iconButton: {
    background: 'transparent', border: 'none', color: 'var(--ps-text-muted-neutral)', cursor: 'pointer',
    fontSize: 11, padding: '2px 4px', flexShrink: 0,
  },
  nameBox: { marginTop: 6 },
  input: {
    width: '100%', boxSizing: 'border-box', background: 'var(--ps-field)', color: 'var(--ps-text-body)',
    border: '1px solid var(--ps-border-strong)', borderRadius: 4, padding: '4px 6px', fontSize: 12,
  },
  buttonRow: { display: 'flex', gap: 6, alignItems: 'center' },
  question: {
    fontSize: 11, lineHeight: 1.45, color: 'var(--ps-text-body)', margin: '6px 0',
    padding: '6px 8px', background: 'var(--ps-surface-note)', border: '1px solid var(--ps-border-strong)', borderRadius: 4,
  },
  notes: {
    fontSize: 10, lineHeight: 1.45, color: 'var(--ps-note-text)', marginBottom: 10,
    padding: '5px 7px', background: 'var(--ps-note-bg)', borderLeft: '2px solid var(--ps-note-border)',
  },
  noteList: { margin: '4px 0', paddingLeft: 14 },
  noteHint: { marginTop: 3, fontStyle: 'italic', color: 'var(--ps-note-hint)' },
  error: {
    fontSize: 11, color: 'var(--ps-error-soft)', marginBottom: 8, whiteSpace: 'pre-wrap',
  },
  hint: { fontSize: 10, color: 'var(--ps-text-faint)', fontStyle: 'italic' },
  list: { display: 'flex', flexDirection: 'column', gap: 2 },
  row: {
    display: 'flex', alignItems: 'center', gap: 2, borderRadius: 4,
    padding: '2px 2px 2px 0',
  },
  rowLoaded: { background: 'var(--ps-row-selected)' },
  rowOpen: {
  ...
  rowName: {
    color: 'var(--ps-text-body)', fontSize: 12, maxWidth: '100%',
    whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
  },
}
