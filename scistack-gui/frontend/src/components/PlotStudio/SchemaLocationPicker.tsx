...
const COLOR: Record<string, string> = {
  green: 'var(--ps-status-green)',
  amber: 'var(--ps-amber)',
  red: 'var(--ps-status-red)',
  grey: 'var(--ps-text-faint-cool)',
}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  muted: { fontSize: 11, color: 'var(--ps-text-muted-slate)', marginBottom: 6 },
  note: {
    fontSize: 11,
    color: 'var(--ps-amber)',
    background: 'var(--ps-amber-bg)',
    border: '1px solid var(--ps-amber-border)',
    borderRadius: 4,
    padding: '4px 8px',
    marginBottom: 6,
  },
  error: { fontSize: 12, color: 'var(--ps-error)', marginBottom: 8 },
  ...
  toggle: { fontSize: 11, color: 'var(--ps-text-muted-slate)', display: 'flex', alignItems: 'center', gap: 4 },
  panes: { display: 'flex', gap: 8, alignItems: 'stretch' },
  scroll: { overflowY: 'auto', maxHeight: '45vh', border: '1px solid var(--ps-border)', borderRadius: 4 },
  ...
  counts: { fontSize: 11, color: 'var(--ps-text-muted-slate)', fontVariantNumeric: 'tabular-nums' },
  excluded: { fontSize: 10, color: 'var(--ps-text-faint-cool)', fontStyle: 'italic' },
  version: {
    fontSize: 10,
    color: 'var(--ps-text-muted-slate)',
    border: '1px solid var(--ps-border)',
    borderRadius: 3,
    padding: '0 4px',
  },
